...
const RegistrationForm1 = ({ user, setUser, setScreen }: { user: IUser, setUser: React.Dispatch<React.SetStateAction<IUser>>,
...
export default function DoctorRegistrationScreen({ navigation }: { navigation: any }) {
