...
const createContext = (defaultValue: any) => {
    ...
    const Context = React.createContext({
        ...
        completeConsultation: ({ appointment_id, payload, onSuccess, onFailure, onCompletion }: { appointment_id: number, payload: any, onSuccess: any, onFailure: any, onCompletion: any }) => { },
