...
import { SignedinUser, DoctorsDetail, CommunicationType } from "../interfaces";
...
const communicationChannels: CommunicationType[] = [
  { id: 1, name: 'In person' },
  { id: 2, name: 'Audio Call' },
  { id: 3, name: 'Video Session' }
];
